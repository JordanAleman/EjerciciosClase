...
public class ExpReg {
    ...
    public static final String[] ARRAY_MESES = { "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio",
    ...
    public static boolean checkNoumSpanish(String noum) {
        ...
        // boolean chekNoumBasic = noum.matches(rexExp.LCap + rexExp.LNoCap1More +
        // "((\\s)" + rexExp.LCap + rexExp.LNoCap1More + ")*");
